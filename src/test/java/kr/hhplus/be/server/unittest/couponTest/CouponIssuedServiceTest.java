...
public class CouponIssuedServiceTest {
    ...
    void couponIssued(){
        ...
        Mockito.verify(couponValidator).validateIssue(any(Coupon.class), Mockito.eq(Optional.empty()));
        Mockito.verify(couponUserRepository).save(any(CouponUserJPA.class));
